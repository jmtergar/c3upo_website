      ...
      var defaults = {
        ...
        jspdf: {orientation: 'p',
                ...
                autotable: {styles: {cellPadding: 2,
                                     rowHeight: 12,
                                     fontSize: 8,
                                     fillColor: 'inherit',        // color value or 'inherit' to use css background-color from html table
                                     textColor: 'inherit',         // color value or 'inherit' to use css color from html table
