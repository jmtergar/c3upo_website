 ...
 */
class UsingTime extends \AppBundle\Entity\UsingTime implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\UsingTime' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\UsingTime' . "\0" . 'code', '' . "\0" . 'AppBundle\\Entity\\UsingTime' . "\0" . 'registeredUsers'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (UsingTime $proxy) {
