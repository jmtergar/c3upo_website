 ...
 */
class Centre extends \AppBundle\Entity\Centre implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Centre' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Centre' . "\0" . 'creator', '' . "\0" . 'AppBundle\\Entity\\Centre' . "\0" . 'created', '' . "\0" . 'AppBundle\\Entity\\Centre' . "\0" . 'editor', '' . "\0" . 'AppBundle\\Entity\\Centre' . "\0" . 'edited', '' . "\0" . 'AppBundle\\Entity\\Centre' . "\0" . 'deletor', '' . "\0" . 'AppBundle\\Entity\\Centre' . "\0" . 'deleted', '' . "\0" . 'AppBundle\\Entity\\Centre' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\Centre' . "\0" . 'registeredUsers'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Centre $proxy) {
