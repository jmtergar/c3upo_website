...
class Department extends \AppBundle\Entity\Department implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Department' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Department' . "\0" . 'creator', '' . "\0" . 'AppBundle\\Entity\\Department' . "\0" . 'created', '' . "\0" . 'AppBundle\\Entity\\Department' . "\0" . 'editor', '' . "\0" . 'AppBundle\\Entity\\Department' . "\0" . 'edited', '' . "\0" . 'AppBundle\\Entity\\Department' . "\0" . 'deletor', '' . "\0" . 'AppBundle\\Entity\\Department' . "\0" . 'deleted', '' . "\0" . 'AppBundle\\Entity\\Department' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\Department' . "\0" . 'registeredUsers'];
        }
