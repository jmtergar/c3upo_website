...
$catalogue = new MessageCatalogue('es', array (
  ...
  array (
    ...
    'clusterInfo.slurm1' => 'El clúster cuenta con los siguientes sistemas de colas:',
    'clusterInfo.slurm.day' => 'Cola <b>diaria</b>. Los trabajos que se ejecuten en esta cola pueden durar como máximo 1 día y pueden hacer uso de 120 cores.',
    'clusterInfo.slurm.day.example' => 'srun -n1 -N1 -p day hostname',
    'clusterInfo.slurm.week' => 'Cola <b>semanal</b>. Los trabajos que se ejecuten en esta cola pueden durar como máximo 7 días y pueden hacer uso de 80 cores.',
    'clusterInfo.slurm.week.example' => 'srun -n1 -N1 -p week hostname',
    'clusterInfo.slurm.week2' => 'Cola <b>quincenal</b>. Los trabajos que se ejecuten en esta cola pueden durar como máximo 14 días y pueden hacer uso de 80 cores.',
    'clusterInfo.slurm.week2.example' => 'srun -n1 -N1 -p week2 hostname',
    'clusterInfo.slurm.month' => 'Cola <b>mensual</b>. Los trabajos que se ejecuten en esta cola pueden durar como máximo 30 días y pueden hacer uso de 40 cores.',
    ...
    'clusterInfo.constraint.set2' => '<b>SET2:</b> Esta característica hace referencia a los nodos nodo01-nodo07.',
    'clusterInfo.constraint.gaussian' => '<b>Gaussian:</b> Esta característica hace referencia a los nodos nodo09-nodo12, que cuentan con mayor capacidad de almacenamiento.',
    'clusterInfo.constraint.gpu' => '<b>GPU:</b> Esta característica hace referencia al nodo nodo13, que nodo cuenta con GPU.',
    'clusterInfo.constraint.web' => '<b>WEB:</b> Esta característica hace referencia a los nodos que se encargarán de realizar las peticiones solicitadas por el servidor web (nodo08).',
